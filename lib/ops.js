  ...
  provide_ops = function() {
    ...
    */
    ...
    return this.slugs_with_metrics_from_slabs = async function(slabs_dtm, settings) {
      var R, XXX_count, XXX_count_max, ctx, defaults, last_slab_idx, line_nr, max_slab_idx, min_slab_idx, partial_slug, prv_slug_metrics, push_metrics, slabs, slug_metrics;
