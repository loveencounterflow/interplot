  ...
  provide_ops = function() {
    ...
    */
    ...
    return this.demo_insert_slabs = function(slabs) {
      ...
      var chrs, delta_mm, delta_pct, delta_px, delta_rel, first_chr, i, is_first_slab, is_last_slab, j, last_chr, left_flag_dom, left_flag_id, left_rect, len, line_nr, margin, margins, ref, ref1, ref2, ref3, rhs, right_flag_dom, right_flag_id, right_rect, slab, slab_count, slab_lnr, slab_rnr, slug_count, slug_dom, slug_id, slug_width/* TAINT use sth like `rpr` */, trim_dom, trim_id, txt, txt_dom;
      margins = {
        'Y': {
          left: '-2mm'
        },
