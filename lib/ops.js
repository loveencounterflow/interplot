  ...
  provide_ops = function() {
    ...
    */
    ...
    this._metrics_from_partial_slug = async function(ctx, partial_slug) {
      var column_dom, column_width_mm, fitting_ok, overshoot_mm, slug_jq, spc_delta_mm, trim_jq, width_mm;
    ...
    this.get_context = async function() {
      var columns_idx, columns_jq, epsilon_mm, live_demo, slug_template;
    ...
    return this.slugs_with_metrics_from_slabs = async function(slabs_dtm, settings) {
      var R, ctx, defaults, last_slab_idx, max_slab_idx, min_slab_idx, partial_slug, prv_slug_metrics, push_metrics, slabs, slug_metrics;
      ...
      R = [];
      //.........................................................................................................
      push_metrics = async function(slug_metrics) {
        var reglet_jq;
        R.push(slug_metrics);
