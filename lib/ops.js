(function() {
  //-----------------------------------------------------------------------------------------------------------
  var after, demo_d3, demo_plotly_1, demo_plotly_ternary, demo_ranges_and_coordinates, log, plot, signal_plot_ready;
  ...
  //-----------------------------------------------------------------------------------------------------------
  demo_ranges_and_coordinates = function() {
    var first_p, newNode, range;
    log = console.log;
    ...
    return range.insertNode(newNode);
  };
