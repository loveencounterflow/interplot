(function() {
  'use strict';
  var $, $drain, CND, DATOM, FS, HYPHENATOR, PATH, SP, alert, assign, badge, cast, debug, help, hyphenate, info, isa, join_path, jr, new_datom, reconstitute_text, rpr, select, type_of, types, urge, validate, warn, whisper;
  ...
  */
  ...
  this.slabs_from_text = function(text) {
    ...
    var LineBreaker, breaker, last_codeunit, lbo, prv_position, slab, slabs, txt;
    text = hyphenate(text);
    ...
    while ((lbo = breaker.nextBreak()) != null) {
      ...
      slab = {};
      if (last_codeunit === HYPHENATOR.soft_hyphen_chr) {
        slab.rhs = 'shy';
