...
(function() {
  ...
  this.main_2 = function() {
    ...
    return this.render(() => {
      ...
      this.JS('https://cdn.plot.ly/plotly-latest.min.js');
      ...
      this.CSS('https://fonts.googleapis.com/css?family=Lobster');
      //=======================================================================================================
      this.DIV('#chart', {
        style: 'border: 1px solid red; background-color: #ffffe6;'
      });
      this.JS('./ops.js');
      return null;
    });
