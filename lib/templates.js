(function() {
  ...
  //###########################################################################################################
  var CND, DATOM, E, FS, H, HTML, INTERTEXT, PATH, alert, badge, css, datoms_as_html, debug, dhtml, help, info, isa, lets, log, new_datom, raw, rpr, script, select, text, type_of, types, urge, validate, warn, whisper;
  ...
  this.elements = E = require('./template-elements');
  ...
  this.layout = function(settings) {
    ...
    /* -------------------------------------------------------------------------------------------------- */
    /* -------------------------------------------------------------------------------------------------- */
    var body, defaults, head, page, public_path, resolve;
  ...
  this.demo_galley = function() {
    var arity, base_path, body, body_def, head, layout_settings, title;
    ...
    return datoms_as_html(this.layout(layout_settings));
  };
