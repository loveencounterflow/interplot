(function() {
  ...
  //###########################################################################################################
  var CND, FS, HTML, INTERTEXT, PATH, SCRIPT, TEACUP, URL, _, alert, badge, cupofhtml, debug, help, id_from_tagname, info, insert, log, rpr, tag_registry, urge, warn, whisper,
...
/* https://github.com/fczbkk/css-selector-generator */    return SCRIPT(function() {
      return ($(document)).ready(function() {
        var sg;
