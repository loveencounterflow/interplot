(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  _.COLUMN = function(...P) {
    return _.TAG('column', ...P, function() {
      return _.TAG('reglet');
    });
  };
...
/* https://github.com/fczbkk/css-selector-generator */    return _.COFFEESCRIPT(function() {
  ...
  this.layout = function(settings) {
    ...
    return _.render(() => {
      ...
      _.CSS(resolve('./jquery-ui-1.12.1/jquery-ui.css'));
      _.JS(resolve('./jquery-ui-1.12.1/jquery-ui.js'));
      ...
      return _.ARTBOARD('#artboard1.pages', function() {
        return _.ZOOMER('#zoomer', function() {
          ...
          _.DIV('.draggable.dropshadow', {
            style: "position:absolute;z-index:100;width:300mm;height:20mm;left:31mm;top:17mm"
          }, function() {
            return _.IMG({
          ...
          _.DIV('.draggable.dropshadow', {
            style: "position:absolute;z-index:100;width:20mm;height:300mm;left:8mm;top:40mm"
          }, function() {
            return _.IMG({
