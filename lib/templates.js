(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  _.DEBUGONOFF = function() {
    _.BUTTON('#debugonoff', "dbg");
    return _.COFFEESCRIPT(function() {
  ...
  _._SLUGCONTAINER = _.new_tag(function(tagname, settings) {
    ...
    _.TAG(tagname, {id, style}, function() {
      var i, nr, ref1, results;
      results = [];
      for (nr = i = 1, ref1 = settings.slugcount; (1 <= ref1 ? i <= ref1 : i >= ref1); nr = 1 <= ref1 ? ++i : --i) {
        results.push(_.SLUG(nr, settings.width));
      }
      return results;
    });
    return null;
  ...
  //-----------------------------------------------------------------------------------------------------------
  _.COMPOSER = _.new_tag(function(settings) {
    return _._SLUGCONTAINER('composer', settings);
  });
    ...
    _.COFFEESCRIPT(function() {
      return ($(document)).ready(function() {
        ...
        f = function() {
          ...
          return this.width_mm_of = function(node) {
