(function() {
  ...
  //###########################################################################################################
  var CND, FS, INTERTEXT, PATH, SCRIPT, TEACUP, URL, _, alert, badge, debug, get_Mycupofhtml, help, id_from_tagname, info, insert, log, rpr, tag_registry, urge, warn, whisper,
  ...
  //###########################################################################################################
  //###########################################################################################################
  get_Mycupofhtml = function() {
    var Cupofhtml, Mycupofhtml, Myspecials, Mytags, Specials, Tags, get_sameid_tag;
    //===========================================================================================================

    //-----------------------------------------------------------------------------------------------------------
    ({Cupofhtml, Tags, Specials} = get_sameid_tag = function(name, blk) {
      return (...P) => {
...
//# sourceMappingURL=_OLD_templates.js.map