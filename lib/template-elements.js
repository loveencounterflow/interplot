    ...
    return [
      ...
      script(function() {
        return ($(document)).ready(function() {
          ...
          console.log('^template-elements@4476-1^',
      "CssSelectorGenerator ready");
          return null;
        });
      })
    ];
    ...
    R.push(script(function() {
      return ($(document)).ready(function() {
        ...
        f = function() {
          ...
          this.height_mm_of = function(node) {
            return this.mm_from_px((as_dom_node(node)).getBoundingClientRect().height);
          };
          return console.log('^template-elements@4476-3^', `element gauge#gauge ready; px_per_mm: ${this.px_per_mm}`);
        };
