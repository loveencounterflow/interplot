(function() {
  module.exports = [
    ...
    /* 2 */
    `Rectangle自馮瀛王始印五經apostolary已後典籍皆為版本其法用膠泥刻字`,
    /* 3 */
    `Yaffir rectangle刻文字apostolary. Letterpress printing.`,
    /* 4 */
...
((至今保藏。))`,
    /* 7 */
    `畢昇發明活字印刷術宋沈括著《夢溪筆談》卷十八記載版印書籍唐人尚未盛為之自馮瀛王始印五經已後典籍皆為版本慶歷中，有布衣畢昇，又為活版。其法用膠泥刻字，薄如錢唇，每字為一印，火燒令堅。先設一鐵版，其上以松脂臘和紙灰之類冒之。欲印則以一鐵範置鐵板上，乃密布字印。滿鐵範為一板，持就火煬之，藥稍鎔，則以一平板按其面，則字平如砥。若止印三、二本，未為簡易；若印數十百千本，則極為神速。常作二鐵板，一板印刷，一板已自布字。此印者才畢，則第二板已具。更互用之，瞬息可就。每一字皆有數印，如之、也等字，每字有二十餘印，以備一板內有重複者。不用則以紙貼之，每韻為一貼，木格貯之。有奇字素無備者，旋刻之，以草火燒，瞬息可成。不以木為之者，木理有疏密，沾水則高下不平，兼與藥相粘，不可取。不若燔土，用訖再火令藥熔，以手拂之，其印自落，殊不沾汙。昇死，其印為余群從所得，至今保藏。`
  ];

}).call(this);

//# sourceMappingURL=sample-texts.js.map