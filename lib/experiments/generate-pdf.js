(function() {
  'use strict';
  var $, CND, FS, LINEMAKER, OPS_slugs_with_metrics_from_slabs, PATH, PD, PUPPETEER, _devtools_node_from_selector, _format, _raw_font_stats_from_selector, after, alert, assign, async, badge, cache, cast, computed_styles_from_selector, debug, demo_2, demo_insert_slabs, echo, echo_browser_console, format_as_percentage, format_float, format_integer, get_all_selectors, get_base_style, get_page, get_ppt_doc_object, help, info, isa, join_path, jr, mark_elements_with_fallback_glyphs, page_html_path, rpr, selectors_from_display_value, settings, show_global_font_stats, sleep, styles_from_nodeid, styles_from_selector, take_screenshot, type_of, types, urge, validate, warn, whisper,
    indexOf = [].indexOf;
