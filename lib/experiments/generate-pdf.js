(function() {
  'use strict';
  var $, CND, FS, LINEMAKER, OPS_slug_from_slabs, PATH, PD, PUPPETEER, after, alert, assign, async, badge, cast, debug, demo_2, demo_insert_slabs, echo_browser_console, get_page, help, info, isa, join_path, jr, page_html_path, rpr, settings, sleep, take_screenshot, type_of, types, urge, validate, warn, whisper;
