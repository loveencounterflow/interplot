(function() {
  'use strict';
  var $, CND, FS, LINEMAKER, PATH, PD, PUPPETEER, after, alert, assign, async, badge, cast, debug, demo_2, demo_insert_slabs, echo_browser_console, get_page, help, info, isa, join_path, jr, page_html_path, rpr, settings, sleep, take_screenshot, type_of, types, urge, validate, warn, whisper;
  ...
  demo_2 = async function() {
    var browser, delta, media, page, path, pdf, ref, target_selector, url;
    ...
    delta = parseFloat((await page.evaluate(function() {
      return ($('p')).offset().left;
    })));
    info('^33987^', "number of DOM elements:          ", jr((await page.evaluate(function() {
      return OPS.demo_jquery_test();
    }))));
    //.........................................................................................................
  ...
  demo_insert_slabs = async function(page) {
    ...
    debug('^222111^', slabs);
    await page.evaluate((function(slabs) {
      return OPS.demo_insert_slabs(slabs);
    }), slabs);
    return null;
  };
