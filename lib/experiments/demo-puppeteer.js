...
(function() {
  'use strict';
  var $, CND, FS, PATH, PD, PUPPETEER, after, alert, assign, async, badge, debug, demo_1, demo_2, help, info, jr, page_html_path, rpr, settings, urge, warn, whisper;
  ...
  demo_2 = async function() {
    ...
    page.on('console', (c) => {
      if (c._type === 'error') {
        ...
        return info('µ37763', 'console:', c._text);
      }
    });
...
//# sourceMappingURL=demo-puppeteer.js.map
