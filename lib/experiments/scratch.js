(function() {
  'use strict';
  var $, $async, $drain, $show, $watch, CND, DATAMILL, DATOM, DEMO, FS, HTML, INTERPLOT, INTERTEXT, PATH, RC, SP, _settings, after, alert, assign, badge, cast, debug, echo, help, info, isa, join_path, jr, lets, new_datom, provide_interplot_extensions, rpr, select, sleep, stamp, type_of, types, urge, validate, warn, whisper;
    ...
    this.$launch = function(S) {
      ...
      this.$XXX_issue_launch_cmd = function(S) {
        ...
        return $({first}, (d, send) => {
          ...
          return send(new_datom('^interplot:launch-browser'));
        });
      };
      //.........................................................................................................
      this.$XXX_launch_proper = function(S) {
        return $async(async(d, send, done) => {
          if (!select(d, '^interplot:launch-browser')) {
            send(d);
            return done();
          }
      ...
      //.........................................................................................................
      pipeline = [];
      pipeline.push(this.$XXX_issue_launch_cmd(S));
      pipeline.push(this.$XXX_launch_proper(S));
