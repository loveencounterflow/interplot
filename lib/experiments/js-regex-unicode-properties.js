(function() {
  //###########################################################################################################
  var CND, _format, alert, badge, cid_matches_pattern, debug, declare, echo, format_float, format_integer, help, i, info, isa, len, log, pattern, patterns, ranges_from_pattern, rpr, show_ranges, size_of, type_of, types, urge, validate, warn, whisper;
