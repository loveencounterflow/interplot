(function() {
  ...
  globalThis.as_html = function(dom_or_jquery) {
    return (_KW_as_dom_node(dom_or_jquery)).outerHTML;
  };
  ...
  //-----------------------------------------------------------------------------------------------------------
  globalThis.get_style = function(dom_or_jquery, pseudo_selector, attribute_name) {
    var style;
    if (attribute_name == null) {
      [pseudo_selector, attribute_name] = [void 0, pseudo_selector];
    }
